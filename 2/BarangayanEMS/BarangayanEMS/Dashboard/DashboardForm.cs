    ...
    public partial class DashboardForm : Form
    {
        ...
        private void BuildPages(string userName)
        {
            ...
            _pageDashboard.Controls.Add(CreateMetricCard(
                "Total Population",
                "204,500",
                Color.FromArgb(77, 109, 242),  // blue-purple
                new Point(24, 120)
            ));
            ...
            _pageDashboard.Controls.Add(CreateMetricCard(
                "Pending Requests",
                "0",
                Color.FromArgb(130, 84, 245),  // purple
                new Point(520, 120)
            ));
            ...
            cardDoc.Paint += (s, e) =>
            {
                ...
                using (GraphicsPath path = RoundedRect(new Rectangle(0, 0, cardDoc.Width - 1, cardDoc.Height - 1), 20))
            ...
            {
                e.Graphics.SmoothingMode = SmoothingMode.AntiAlias;
                using (GraphicsPath path = RoundedRect(new Rectangle(0, 0, cardBlotter.Width - 1, cardBlotter.Height - 1), 20))
