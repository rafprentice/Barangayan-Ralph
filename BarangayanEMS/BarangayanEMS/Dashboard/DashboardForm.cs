...
namespace BarangayanEMS
{
    public partial class DashboardForm : Form
    {
        ...
        private void BuildPages(string userName)
        {
            ...
            Panel cardResidents = CreateMetricCard(
                "Registered Residents", "12,540",
                Color.FromArgb(98, 78, 255),
                new Point(24, 110));

            Panel cardPending = CreateMetricCard(
                "Pending Requests", "85",
                Color.FromArgb(134, 69, 255),
                new Point(cardResidents.Right + 16, 110));

            Panel cardAnnounce = CreateMetricCard(
                "Announcements", "5",
                Color.FromArgb(0, 163, 214),
                new Point(cardPending.Right + 16, 110));

            _pageDashboard.Controls.Add(cardResidents);
            _pageDashboard.Controls.Add(cardPending);
            _pageDashboard.Controls.Add(cardAnnounce);
