...
namespace BarangayanEMS
{
    partial class LoginForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            // === QR LOGIN COMING SOON ICON ===
            this.iconQRLarge = new BarangayanEMS.IconPictureBox();
            this.iconQRLarge.AutoRound = false;
            this.iconQRLarge.BackColor = Color.Transparent;
            this.iconQRLarge.Image = ((System.Drawing.Image)(resources.GetObject("iconQR.Image"))); // Use your QR image here
            this.iconQRLarge.Location = new Point(480, 110);   // adjust if needed
            this.iconQRLarge.Name = "iconQRLarge";
            this.iconQRLarge.Size = new Size(160, 160);
            this.iconQRLarge.SizeMode = PictureBoxSizeMode.Zoom;
            this.iconQRLarge.Cursor = Cursors.Hand;
            this.iconQRLarge.Click += new System.EventHandler(this.IconQRLarge_Click);
            this.pnlLoginCard.Controls.Add(this.iconQRLarge);

            // === QR COMING SOON LABEL ===
            this.lblQrComingSoon = new Label();
            this.lblQrComingSoon.AutoSize = true;
            this.lblQrComingSoon.Cursor = Cursors.Hand;
            this.lblQrComingSoon.Font = new Font("Segoe UI", 9.5F, FontStyle.Underline);
            this.lblQrComingSoon.ForeColor = Color.FromArgb(64, 0, 255);
            this.lblQrComingSoon.Location = new Point(495, 275);
